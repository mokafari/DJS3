...
// Note: stackenter is implemented in AudioGeneratorMP3.cpp for C++ files
// For C files, we need to declare it as a function
# ifndef __cplusplus
extern void stackenter(const char *s, const char *t, int i);
...
/* Include ESP8266Audio compatibility header for PROGMEM and PSTR macros */
#ifdef __cplusplus
#include "esp8266audio_compat.h"
#else
// C-only compatibility macros (no C++ classes)
#define PROGMEM
#define PSTR(x) x
